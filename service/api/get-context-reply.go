...
// GetContextReply is an example of HTTP endpoint that returns "Hello World!" as a plain text
// The signature of this handler accepts a reqcontext.RequestContext (see httpRouterHandler)
